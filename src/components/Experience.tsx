...
const experiences = [
  {
    ...
    type: "Full-time",
    description:
      "Leading data science initiatives for enterprise clients, developing predictive models and advanced analytics solutions.",
    achievements: [
  ...
  },
  {
    ...
    type: "Full-time",
    description:
      "Specialized in business intelligence and statistical analysis for financial services clients.",
    achievements: [
  ...
  },
  {
    ...
    type: "Full-time",
    description:
      "Focused on customer analytics and growth optimization for e-commerce platforms.",
    achievements: [
  ...
  },
  {
    ...
    type: "Internship",
    description:
      "Conducted statistical research and analysis on healthcare data for academic publications.",
    achievements: [
              ...
              <div className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-lg">
                <div className="space-y-4">
                  {certifications.map((cert, index) => (
                    ...
                    >
                      ...
                      >
                        <svg
                          className="w-5 h-5 text-blue-600 hover:text-teal-600 transition"
                          fill="none"
                          stroke="currentColor"
                          strokeWidth="2"
                          viewBox="0 0 24 24"
                ...
                >
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300">
                    ...
                    data science and analytics. Regularly pursuing additional
