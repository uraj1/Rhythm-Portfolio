...
const Projects = () => {
  ...
  icon: Brain
    ...
    {
      id: 2,
      title: 'T20 Cricket Analysis & Dashboard',
      category: 'Data Visualization',
      description: 'Dynamic Power BI dashboard transforming T20 cricket data into actionable insights for optimal team selection, player evaluation, and performance analysis.',
      longDescription: 'This project delivers a data-driven solution for T20 team selection by transforming raw cricket data into interactive insights. Leveraging Power BI, advanced DAX, and robust data modeling, it enables dynamic player evaluation, trend analysis, and optimal team simulation. Features include role-based filtering, player comparison, final 11 selector, and interactive profiles that assist analysts, coaches, and selectors in making informed decisions.',
      image: 'https://hunarho.com/wp-content/uploads/2024/06/Cricanalysis1-1024x585.webp',
      technologies: ['Bright Data', 'Power Query', 'Power BI', 'DAX', 'CSV'],
      metrics: [
    'Players: 150+',
    'Strike Rate: 110-190',
    'Avg Boundaries: 12.3',
    ...
    'Form Accuracy: 90%'
      ...
      github: 'https://github.com/rhythmgarg2606/T20-Cricket-Analysis',
      demo: 'https://github.com/rhythmgarg2606/T20-Cricket-Analysis/blob/main/Cricket%20Best%2011%20Analysis.pbix',
      icon: BarChart3,
    },
    {
      id: 3,
      title: 'Dynamic Weather TS Analysis',
      category: 'Statistical Analysis',
      description: 'Interactive Streamlit dashboard for temperature trend analysis and 7-day forecasting using ARIMA and Prophet models.',
      longDescription: 'Developed a fully functional weather analytics dashboard with live API and CSV support. Implemented STL decomposition, ADF/KPSS tests for stationarity, and integrated ARIMA & Prophet models for 7-day temperature prediction. Enhanced user engagement through interactive charts and clean UI powered by Streamlit.',
      image: 'https://miro.medium.com/v2/resize:fit:1400/1*8MlkRf5Wt4PyyJW0j-8grQ.png',
      technologies: ['Python', 'Streamlit', 'ARIMA', 'Prophet', 'Pandas', 'Plotly'],
      metrics: [ 'Live Weather Support',
    '7-Day Forecasts',
    'Dual Model Analysis (ARIMA/Prophet)',
    'STL + Stationarity Tests'],
      github: 'https://github.com/rhythmgarg2606/weather-ts-dashboard',
      demo: 'https://www.linkedin.com/posts/rhythm-garg-93b1ba208_dynamic-weather-time-series-dashboard-report-activity-7339656623570735105-RcqS/',
      icon: TrendingUp,
    },
    // {
    //   id: 4,
